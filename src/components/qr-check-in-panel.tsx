...
export function QrCheckInPanel({ destinationUrl, qrDataUrl, qrError }: { destinationUrl: string | null; qrDataUrl: string | null; qrError: string | null }) {
  ...
  if (!destinationUrl) {
    return (
       <section className="rounded-[1.75rem] border border-[#ead98a] bg-[#fff9d9] p-6 sm:p-8">
  ...
  return (
     <section className="rounded-[1.75rem] border border-[#dfddd4] bg-white p-5 shadow-[0_20px_55px_rgba(0,0,0,0.08)] sm:p-8 print:border-0 print:p-0 print:shadow-none">
       <div className="text-center">
         <Image alt="Cool Car Centrale" className="mx-auto h-auto w-[180px] rounded-xl bg-white object-contain p-1 sm:w-[220px]" height={1000} sizes="(max-width: 639px) 180px, 220px" src="/img/logo.jpg" width={2000} />
         <p className="mt-6 text-[0.68rem] font-bold uppercase tracking-[0.22em] text-[#a77f00]">Customer Check-In</p>
         <h2 className="mt-3 text-3xl font-bold tracking-[-0.05em] text-[#171717]">Scan to start your visit.</h2>
       ...
       <div className="mx-auto mt-7 flex min-h-[320px] max-w-[420px] items-center justify-center rounded-2xl border border-[#dfddd4] bg-white p-4 sm:p-6 print:mt-10 print:border-0">
       ...
       <div className="mt-6 rounded-2xl bg-[#f7f6f1] p-4 text-center print:mt-8">
       ...
       <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-center print:hidden">
         ...
         <button className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl border border-[#d7d4ca] bg-white px-5 text-sm font-bold text-[#292929] transition-colors hover:border-[#c7a900] hover:bg-[#fffdf2]" onClick={() => window.print()} type="button">
          Print QR
        </button>
      </div>

       <p className="mt-6 flex items-center justify-center gap-2 text-center text-xs font-semibold text-[#89867d] print:hidden">
