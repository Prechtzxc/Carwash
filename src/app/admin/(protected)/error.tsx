...
export default function AdminError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <section aria-labelledby="admin-error-title" className="rounded-[1.5rem] border border-[#f0d3c8] bg-[#fff8f6] p-6 sm:p-8" role="alert">
       <p className="text-[0.68rem] font-bold uppercase tracking-[0.22em] text-[#b34646]">Admin page unavailable</p>
       <h1 className="mt-3 text-2xl font-bold tracking-[-0.04em] text-[#6f3333]" id="admin-error-title">We could not load this page.</h1>
